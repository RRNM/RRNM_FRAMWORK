...
//Public Methods
    ...
    public void openAlignment(String path) throws Exception
    {
    	...
    	{
    		activeMapping = 0;
    	System.out.println("Alignment Oepned");}
    	if(userInterface != null)
    		userInterface.refresh();
    	needSave =true;
    }
	...
	public void openOntologies(String src, String tgt) throws OWLOntologyCreationException
	{
		...
		uris = new URIMap();
		rels = new RelationshipMap();
		System.out.println("resoner"+useReasoner);
		if(useReasoner)
   ...
   public void saveAlignmentRDF(String file) throws Exception
    ...
    public void saveAlignmentRDF(String file, String Onto1, String Onto2) throws Exception
    {

    	a.saveRDF(file,Onto1,Onto2);
    	needSave = true;
    }
