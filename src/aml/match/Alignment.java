...
//Constructors
	 ...
	 */
	public Alignment(String file, boolean yes) throws Exception
	{
		this();
		...
		{System.out.println("Loading Done");
			...
			throw new Exception("Unrecognized alignment formathhhhh!");
	}
...
//Public Methods
	...
	public void checkclass (int targetid)
	{
	...
	{
		return sourceMaps.contains(Id);
	}
	public String getURIClass(int Id)
	{
		if (sourceMaps.contains(Id))
	...
	public int getTargetMatch(int targetId)
	{
		double max = 0;
		int source = -1;
		Set<Integer> sources = sourceMaps.keySet(targetId);
	...
	public String getTargetMatchName(int targetId, String Name)
	{
		...
		for(Integer i : sources)
		{
			...
			if (Name.equals(AML.getInstance().getSource().getName((i))))
				return "yes";
						AML.getInstance().getTarget().getName((i));
		
		}
		return source;
	}
	public String getSourceMatchName(int targetId, String Name)
	{
		...
		for(Integer i : sources)
		{
			...
			if (Name.equals(AML.getInstance().getTarget().getName((i))))
			return	"yes";
					//AML.getInstance().getTarget().getName((i));
	 ...
	 */
	public void saveRDF(String file, String Onto1, String Onto2) throws FileNotFoundException
	{
		...
		outStream.println("\t<onto1>" + Onto1 + "</onto1>");
		outStream.println("\t<onto2>" + Onto2 + "</onto2>");
